...
public enum eThrowEventType
{
    ...
    E_THROW_EVENT_TYPE_INIT_NORMAL_SKILL,
    E_THROW_EVENT_TYPE_SELECT_NORMAL_SKILL,
    E_THROW_EVENT_TYPE_SKILL_HIT,
    E_THROW_EVENT_TYPE_SKILL_HEAL,
    E_THROW_EVENT_TYPE_SKILL_KNOCKBACK,
    E_THROW_EVENT_TYPE_SKILL_PULL,
    E_THROW_EVENT_TYPE_CHARACTER_DIE,
    ...
    // --2016_03_21
    E_THROW_EVENT_TYPE_MONSTER_MARKING,
    E_THROW_EVENT_TYPE_MAKE_SKILLAREARENDER,
    E_THROW_EVENT_TYPE_MOVE_SKILLAREARENDER,

    // --2016_03_23
    E_THROW_EVENT_TYPE_MOVETOSKILLTARGET,
    E_THROW_EVENT_TYPE_USE_HABANA_SKILL,
    E_THROW_EVENT_TYPE_USE_TAP_SKILL,

    // -- 2016_04_11
    E_THROW_EVENT_TYPE_RESET_SKILLTARGET,

    // --2016_05_04
    E_THROW_EVENT_TYPE_CASTINGEFFECT,

    // --2016_05_09
    E_THROW_EVENT_TYPE_SKILLCANCEL,

    E_THROW_EVENT_TYPE_SKILL_CASTINGEFFECT_ON,
    E_THROW_EVENT_TYPE_SKILL_CASTINGEFFECT_OFF,

    E_THROW_EVENT_TYPE_CONTROL_MODE,
    E_THROW_EVENT_TYPE_AUTO_ENEMY_SEARCH_MODE,

    E_THROW_EVENT_TYPE_CREAT_SOCIALSKILL_BUTTON,
    E_THROW_EVENT_TYPE_CREAT_SOCIALSKILL_CHAT,

    E_THROW_EVENT_TYPE_CREAT_MOVIE_CHATTING_BOARD,
    E_THROW_EVENT_TYPE_CREAT_MOVIE_EMOTICON_BOARD,

    E_THROW_EVENT_TYPE_SOCIALSKILL_LINKEFFECT_ON,
    E_THROW_EVENT_TYPE_SOCIALSKILL_LINKEFFECT_OFF,

    E_THROW_EVENT_TYPE_CREAT_SOCIALSKILL_LINK_EFFECT,


    E_THROW_EVENT_TYPE_CHANGE_EVENT_MOVIE_STATE,

    E_THROW_EVENT_TYPE_DESPAWN_SOCIALEFFECT,

    E_THROW_EVENT_TYPE_RUN_PASSIVE_SKILL_OPTION,
    E_THROW_EVENT_TYPE_CHECK_GETHIT_PASSIVE,
    E_THROW_EVENT_TYPE_ATTACK_DRAIN,
    E_THROW_EVENT_TYPE_SKILL_DRAIN,
    E_THROW_EVENT_TYPE_DAMAGE_REFLECT,
    E_THROW_EVENT_TYPE_DECREASE_SKILL_COOLTIME_BY_KILL,
    E_THROW_EVENT_TYPE_DECREASE_SKILL_COOLTIME,
    E_THROW_EVENT_TYPE_DAMAGE_PER_MAXHP,

    E_THROW_EVENT_TYPE_SET_AGGRO_TARGET,

    E_THROW_EVENT_TYPE_MANAGER_PAUSE,
    E_THROW_EVENT_TYPE_MANAGER_CLEAN,
    E_THROW_EVENT_TYPE_MANAGER_RESET,
    E_THROW_EVENT_TYPE_MANAGER_RELEASE,

    E_THROW_EVENT_TYPE_MAKE_CROWDCONTROL_BOARD,
    E_THROW_EVENT_TYPE_MAKE_SKILLCANCEL_BOARD,

    E_THROW_EVENT_TYPE_SKILL_MONSTER_DIE_DRAIN_ONLY_OWNER,
    E_THROW_EVENT_TYPE_SKILL_ADD_NORMAL_DAMAGE,
}
